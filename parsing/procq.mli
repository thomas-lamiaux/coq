...
type 'a entry_command
(** Type of synchronized entry creation. *)

val create_entry_command : string -> 'a entry_command
(** Create a new entry-creating command with the given name. *)

val extend_entry_command : 'a entry_command -> string -> CustomName.t -> 'a Entry.t
(** Create a new synchronized entry using the provided prefix and name. *)

val find_custom_entry : 'a entry_command -> CustomName.t -> 'a Entry.t
