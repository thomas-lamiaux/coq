...
val extend_entry_command : 'a entry_command -> string -> 'a Entry.t
(** Create a new synchronized entry using the provided name. *)

val find_custom_entry : 'a entry_command -> string -> 'a Entry.t
