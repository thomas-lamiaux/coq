...
let rec_dep =
  declare_individual_scheme_object "rec_dep"
    (fun env _ -> build_induction_scheme_in_type env true QualityOrSet.set)

let ind_dep =
  declare_individual_scheme_object "ind_dep"
    (fun env _ -> build_induction_scheme_in_type env true QualityOrSet.prop)
...
let rec_nodep =
  declare_individual_scheme_object "rec_nodep"
    (fun env _ -> build_induction_scheme_in_type env false QualityOrSet.set)

let ind_nodep =
  declare_individual_scheme_object "ind_nodep"
    (fun env _ -> build_induction_scheme_in_type env false QualityOrSet.prop)
